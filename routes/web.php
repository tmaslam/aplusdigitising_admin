...
Route::middleware('detect.site')->group(function () use ($adminPrefix, $internalPortalPath) {
    ...
    Route::match(['get', 'post'], '/api/contact', [CustomerSiteController::class, 'sendContact']);
    ...
    Route::post('/my-profile/subscription/pause', [CustomerAccountController::class, 'pauseSubscription'])->middleware('customer.auth');
    Route::post('/my-profile/subscription/cancel', [CustomerAccountController::class, 'cancelSubscription'])->middleware('customer.auth');
    ...
    Route::get('/buy-subscription.php', [CustomerPortalController::class, 'buySubscription'])->middleware('customer.auth');
    Route::post('/buy-subscription.php', [CustomerPortalController::class, 'buySubscription'])->middleware('customer.auth');
...
Route::middleware('admin.auth')->group(function () use ($adminPrefix) {
    ...
    Route::get('/v/subscription-customers.php', [AdminPeopleController::class, 'subscriptionCustomers']);
    Route::match(['get', 'post'], '/v/create-customer.php', [AdminPeopleController::class, 'createCustomer']);
    ...
    Route::post('/v/change-password-2fa', [AdminProfileController::class, 'adminPasswordVerify2FA']);
    Route::post('/v/change-password-2fa-resend', [AdminProfileController::class, 'adminPasswordResend2FA']);
