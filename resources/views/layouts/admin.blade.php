    ...
    <aside class="sidebar">
        ...
        <div class="nav-list">
            <div class="nav-card">
                ...
                <a href="{{ \App\Support\AdminOrderQueues::url('designer-orders') }}" class="{{ (request()->is('v/orders/*') || request()->is('v/orders.php')) && $activeQueue !== null && $activeQueue === 'designer-orders' ? 'active' : '' }}"><span>Assigned Orders</span><span class="count">{{ $navCounts['designer_orders'] ?? 0 }}</span></a>
