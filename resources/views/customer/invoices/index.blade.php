...
@section('content')
    <section class="content-card">
        ...
        <form method="get" action="/aplus/view-invoices.php" class="invoice-filterbar">
            ...
            <div class="field-actions">
                ...
                <a class="button secondary" href="/aplus/view-invoices.php">Reset</a>
            </div>
            ...
            <div class="table-wrap responsive-stack">
                <table class="responsive-table">
                    ...
                    @foreach ($invoiceGroups as $invoice)
                        <tr>
                            <td><a class="button secondary" href="/aplus/view-invoice-detail.php?transid={{ urlencode($invoice->transid) }}&origin=invoices">View</a></td>
