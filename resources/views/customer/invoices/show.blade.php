    ...
    <section class="content-card">
        <div class="section-head">
            ...
            <div class="invoice-detail-actions">
                <a class="button secondary" href="/aplus/view-invoices.php">Back to Invoices</a>
                <a class="button secondary" href="/aplus/view-invoice-detail.php?transid={{ urlencode($transactionId) }}&download=pdf">Download Invoice</a>
            ...
            <table class="responsive-table">
                ...
                @foreach ($invoiceItems as $billing)
                    <tr>
                        <td>
                            @if ($billing->order)
                                <a href="/aplus/view-order-detail.php?order_id={{ $billing->order->order_id }}&origin=invoices">{{ $billing->order->order_id }}</a>
                            @else
                                {{ $billing->order_id }}
                            @endif
                        </td>
