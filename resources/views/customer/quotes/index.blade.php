    ...
    <section class="content-card">
        <div class="section-head">
            ...
            <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                ...
                <a class="button secondary" href="/aplus/quote.php">Start Digitizing Quote</a>
                <a class="button secondary" href="/aplus/vector-quote.php">Start Vector Quote</a>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="action-cell" data-label="Action">
                                <div class="action-group">
                                    <a class="button secondary" href="/aplus/view-quote-detail.php?order_id={{ $quote->order_id }}&origin=quotes">View Detail</a>
                                    <a class="button secondary" href="/aplus/view-quote-detail.php?order_id={{ $quote->order_id }}&origin=quotes#quote-response">Switch To Order</a>
                                    <form method="post" action="/aplus/quotes/{{ $quote->order_id }}/delete" onsubmit="return confirm('Delete this quote?');">
                                        @csrf
