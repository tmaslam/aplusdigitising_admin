...
@section('content')
    @php
        ...
        $faqs = [
            ...
            ['question' => 'How do I send you my design?', 'answer' => 'You can upload your design directly through our quote request form. We accept JPG, PNG, and PDF files. You can also email your design to support@aplusdigitising.com. For best results, please send high-resolution images (300 DPI or higher).'],
