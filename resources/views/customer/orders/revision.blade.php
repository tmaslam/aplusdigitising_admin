...
@section('content')
    <section class="content-card single-column">
        <div class="section-head">
            ...
            <a class="button secondary" href="/aplus/view-order-detail.php?order_id={{ $order->order_id }}">Back to Order</a>
        </div>

        <form method="post" action="/aplus/disapprove-order.php?order_id={{ $order->order_id }}" enctype="multipart/form-data" class="form-grid">
            @csrf
            ...
            <div style="grid-column: 1 / -1; display: flex; gap: 12px; flex-wrap: wrap;">
                ...
                <a class="button secondary" href="/aplus/view-order-detail.php?order_id={{ $order->order_id }}">Cancel</a>
            </div>
        </form>
    </section>
