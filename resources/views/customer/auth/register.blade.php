...
@section('title', 'A Plus Digitizing Sign Up')
                ...
                <section class="form-section">
                    <label class="terms-row" data-form-field>
                        ...
                        <span class="terms-copy">
                            <span class="terms-line"><span class="field-meta required" aria-hidden="true">*</span><span>I have read the <a href="http://localhost/aplusweb/terms" target="_blank" rel="noopener">Terms &amp; Conditions</a> thoroughly, and I agree.</span></span>
                            <span class="field-error" data-field-error aria-live="polite"></span>
                        </span>
                    </label>
                </section>
