    ...
    */
    'fallback_sites' => [
        '1dollar' => [
            ...
            'support_email' => env('SITE_SUPPORT_EMAIL', env('SITE_FROM_EMAIL', env('LEGACY_FROM_EMAIL', env('MAIL_FROM_ADDRESS', 'support@aplusdigitising.com')))),
            'from_email' => env('SITE_FROM_EMAIL', env('MAIL_FROM_ADDRESS', 'support@aplusdigitising.com')),
