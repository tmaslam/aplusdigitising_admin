...
class CustomerUploadPolicy
{
    ...
    public static function customerSourceRulesSummary(): array
    {
        return [
            ...
            'source_allowed' => ['pdf', 'jpg', 'jpeg', 'png', 'gif', 'bmp', 'tif', 'tiff', 'svg', 'ai', 'eps', 'cdr', 'psd', 'dst', 'emb', 'pes', 'exp', 'jef', 'hus', 'vp3', 'xxx', 'dsb', 'dsz', 'tap', 'u01', 'cnd', 'pxt', 'pxf', 'ngs'],
            'production_allowed' => ['pdf', 'jpg', 'jpeg', 'png', 'ai', 'eps', 'svg', 'cdr', 'psd', 'dst', 'emb', 'pes', 'exp', 'jef', 'hus', 'vp3', 'xxx', 'dsb', 'dsz', 'tap', 'u01', 'cnd', 'pxt', 'pxf', 'ngs'],
        ];
    }
